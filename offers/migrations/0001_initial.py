    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('item_condition', models.CharField(choices=[('perfect', 'отличное'), ('good', 'хорошее'), ('bad', 'плохое')], verbose_name='Состояние')),
                ...
                ('event_name', models.ManyToManyField(to='offers.eventtheme')),
            ],
            options={
