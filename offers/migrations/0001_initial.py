    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.CharField(choices=[('property', 'Недвижимость'), ('transport', 'Транспорт'), ('job', 'Работа'), ('service', 'Услуги'), ('taxi', 'Такси'), ('event', 'События')], max_length=100, verbose_name='Категории')),
