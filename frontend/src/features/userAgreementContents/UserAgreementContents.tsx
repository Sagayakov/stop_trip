    ...
    return (
        <>
            ...
            <div className={styles.contents_list}>
                <ol>
                    <li>
                        <Link to="general" activeClass="active" offset={-80}>
                            {t('user_agreement.1_header')}
                        </Link>
                    </li>
                    <li>
                        <Link to="subject" activeClass="active" offset={-80}>
                    ...
                    <li>
                        <Link to="rights" activeClass="active" offset={-80}>
                            {t('user_agreement.4_header')}
                        </Link>
                    </li>
                    <li>
                        <Link to="dispute" activeClass="active" offset={-80}>
                            {t('user_agreement.5_header')}
                        </Link>
                    </li>
                    <li>
                        <Link to="changes" activeClass="active" offset={-80}>
                            {t('user_agreement.6_header')}
                        </Link>
                    </li>
                    <li>
                        <Link to="final" activeClass="active" offset={-80}>
                            {t('user_agreement.7_header')}
                        </Link>
                    </li>
                    <li>
                        <Link to="processing" activeClass="active" offset={-80}>
