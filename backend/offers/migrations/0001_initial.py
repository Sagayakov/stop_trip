# Generated by Django 4.2.5 on 2023-11-09 16:42
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('transport_transmission_type', models.CharField(blank=True, choices=[('mechanic', 'Механическая'), ('automatic', 'Автоматическая'), ('robot', 'Робот')], max_length=50, null=True, verbose_name='Тип коробки передач')),
                ...
                ('coordinate', location_field.models.plain.PlainLocationField(blank=True, max_length=63, verbose_name='Координаты')),
