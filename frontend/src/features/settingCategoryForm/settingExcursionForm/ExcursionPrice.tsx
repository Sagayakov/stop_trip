...
import { TypeForExcursionFilter, Price } from 'widgets/settingForm/settingExcursion/libr/TypeForExcursionFilter.ts';
...
export const ExcursionPrice = ({ register, available_params }: Props) => {
