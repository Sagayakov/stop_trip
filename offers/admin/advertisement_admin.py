...
class AdvertisementAdmin(ModelAdmin):
    ...
    fieldsets = ((None, {"fields": ("owner", "category", "title", "price", "description", "is_published", "slug",)}),
                 (_("Транспорт"), {"fields": ("transport_type_of_service",
                                              "transport_type",
                                              "transport_category",
                                              "transport_brand",
                                              "transport_model",
                 ...
                 (_("Недвижимость"), {"fields": ("property_type_of_service",
                                                 "property_city",
                                                 "property_district",
                                                 "property_coords",
                 ...
                 (_("Такси"), {"fields": ("taxi_unit",
                                          "taxi_type",)}),
                 (_("Поездки"), {"fields": ("trip_unit",)}),

                 (_("Работа"), {"fields": ("job_type",
                                           "job_duration",
                                           "job_payment_type",
                                           "job_experience",
                                           )}),
                 (_("Мероприятия"), {"fields": ("start_date",
                                                "end_date",
                                                "is_online",
                                                )}),
                 )
    add_fieldsets = (
        (None, {
            ...
            "fields": ("category", "title",
                       "price", "description", "is_published",
                       "transport_type_of_service", "transport_type",
                       "transport_category",
                       "transport_brand",
                       "transport_model",
                       "transport_engine_type",
