...
import { TypeOfServicesForm, Price } from 'widgets/settingForm/settingServices/libr/TypeOfServicesForm.ts';
...
export const SettingServicePrice = ({ register, available_params }: Props) => {
