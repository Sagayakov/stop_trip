# Generated by Django 4.2.5 on 2023-12-01 16:12
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('property_rental_condition', models.CharField(blank=True, choices=[('family', 'Семье'), ('alone', 'Для одного'), ('girls', 'Девушке'), ('office', 'Под офис'), ('students', 'Студентам'), ('not_companies', 'Не компаниям')], max_length=100, verbose_name='Условия аренды')),
                ...
                ('property_sleeping_places', models.PositiveSmallIntegerField(blank=True, null=True, verbose_name='Количество спальных комнат')),
                ('property_rooms_count', models.PositiveSmallIntegerField(blank=True, null=True, verbose_name='Количество комнат')),
                ('property_commission', models.PositiveSmallIntegerField(blank=True, null=True, verbose_name='Комиссия')),
                ...
                ('transport_transmission_type', models.CharField(blank=True, choices=[('mechanic', 'Механическая'), ('automatic', 'Автоматическая'), ('robot', 'Робот'), ('cvt', 'Вариатор')], max_length=50, null=True, verbose_name='Тип коробки передач')),
                ...
                ('transport_commission', models.PositiveSmallIntegerField(blank=True, null=True, verbose_name='Комиссия')),
                ...
                ('job_duration', models.CharField(blank=True, choices=[('one_time_task', 'Разовое задание'), ('temporary', 'Временная работа'), ('permanent', 'Постоянная работа'), ('other', 'Другое')], max_length=25, null=True, verbose_name='Продолжительность работы')),
                ...
                ('service_home_visit', models.BooleanField(default=False, verbose_name='Выезд на дом')),
                ...
                ('document_type', models.CharField(blank=True, choices=[('tourist-visa', 'Туристская виза'), ('business-visa', 'Бизнес-виза'), ('c-form', 'C-форма'), ('exit-permit', 'Продление выезда'), ('other', 'Другое')], max_length=50, verbose_name='Тип документа')),
                ('document_duration', models.CharField(blank=True, choices=[('month', 'Месяц'), ('quarter', 'Квартал'), ('year', 'Год'), ('years_5', '5 лет'), ('other', 'Другое')], max_length=50, verbose_name='Срок действия')),
                ('market_condition', models.CharField(blank=True, choices=[('new', 'Новое'), ('used', 'Б/У')], max_length=25, null=True, verbose_name='Состояние')),
                ('excursion_food', models.BooleanField(default=False, verbose_name='Включена еда')),
                ('excursion_transfer', models.BooleanField(default=False, verbose_name='Трансфер')),
                ('food_delivery', models.BooleanField(default=False, verbose_name='Доставка на дом')),
                ('food_establishment', models.BooleanField(default=False, verbose_name='Ресторан/кафе')),
                ('food_type', models.CharField(blank=True, choices=[('veg_food', 'Вегетарианская еда'), ('non_veg_food', 'Невегетарианская еда'), ('ready_food', 'Готовая еда'), ('semi_finished_food', 'Полуфабрикаты'), ('other_food', 'Другое')], max_length=50, verbose_name='Тип еды')),
                ('category', models.CharField(choices=[('property', 'Недвижимость'), ('transport', 'Транспорт'), ('job', 'Работа'), ('service', 'Услуги'), ('taxi', 'Такси'), ('event', 'События'), ('exchange_rate', 'Обмен валюты'), ('market', 'Купить-продать'), ('document', 'Документы'), ('food', 'Еда'), ('excursion', 'Экскурсии')], max_length=100, verbose_name='Категории')),
                ('title', models.CharField(max_length=100, verbose_name='Название')),
                ('price', models.PositiveIntegerField(blank=True, null=True, verbose_name='Цена')),
                ('coordinates', location_field.models.plain.PlainLocationField(blank=True, max_length=63, verbose_name='Координаты')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(db_index=True, verbose_name='Название')),
                ('slug', models.SlugField(unique=True, verbose_name='Слаг')),
                ('country', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='regions', to='offers.country', verbose_name='Страна')),
            ],
            options={
                'verbose_name': 'Регион',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(db_index=True, verbose_name='Название')),
                ('slug', models.SlugField(unique=True, verbose_name='Слаг')),
                ('region', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='cities', to='offers.region', verbose_name='Город')),
            ],
            options={
                'verbose_name': 'Город',
        ...
        migrations.AddField(
            ...
            name='city',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='advertisements', to='offers.city', verbose_name='Город'),
        ),
        migrations.AddField(
            model_name='advertisement',
            name='country',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='advertisements', to='offers.country', verbose_name='Страна'),
        ),
        migrations.AddField(
            model_name='advertisement',
            name='exchange_for',
        ...
        migrations.AddField(
            model_name='advertisement',
            name='region',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='advertisements', to='offers.region', verbose_name='Район'),
        ),
        migrations.AddField(
            model_name='advertisement',
