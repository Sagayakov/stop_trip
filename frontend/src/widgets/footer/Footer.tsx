        ...
        <footer>
            <div className={styles.footer_wrapper}>
                <div className={styles.footer_top}>
                    ...
                    <FeedbackForm showCaptcha={showCaptcha} setShowCaptcha={setShowCaptcha} />
                </div>
                <div className={styles.hr}>{/*Выводим капчу по клику по форме*/}
                    <div className={styles.reCaptcha_brand} style={opacity()} >{/*для линцензионного соглашения с google*/}
