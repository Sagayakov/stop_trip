...
export const AnnouncementJobWithExp = ({ register, defaultValue, formState, setValue }: Props) => {
    ...
    return (
        <div className={styles.ann_field}>
            <h3>{t('filters.job_experience')}{isRequired && <span>*</span>}:</h3>
            <label>
                <input
                    type="checkbox"
                    ...
                    onChange={(event) => setValue('job_experience',event.target.checked)}
